      ...
      <div className="py-8 mt-[-140px]">
        ...
        <div className="max-w-3/4 w-full sm:w-[90%] mx-auto mt-8 text-justify">
          <div className="text-justify">
            ...
            <p className="text-base font-medium mb-4">
              <strong>CRAFTINDIKA RETAIL PRIVATE LIMITED</strong> (“us”, “we”,
              or “our”) operates <strong>craftindika.com</strong> (hereinafter
              referred to as <strong>“Service”</strong>).
            </p>

            <p className="text-base font-medium mb-4">
              Our Privacy Policy governs your visit to{" "}
              <strong>craftindika.com</strong>, and explains how we collect,
            ...
            <p className="text-base font-medium mb-4">
              <strong>SERVICE</strong> means the craftindika.com website
              operated by CRAFTINDIKA RETAIL PRIVATE LIMITED.
            </p>
            ...
            <p className="text-base font-medium mb-4">0.1. Email address</p>

            <p className="text-base font-medium mb-4">
              0.2. First name and last name
            </p>

            <p className="text-base font-medium mb-4">0.3. Phone number</p>
            ...
            <p className="text-base font-medium mb-4">
              CRAFTINDIKA RETAIL PRIVATE LIMITED uses the collected data for
              various purposes:
            </p>
            ...
            <p className="text-base font-medium mb-4">
              CRAFTINDIKA RETAIL PRIVATE LIMITED will take all the steps
            ...
            <p className="text-base font-medium mb-4">
              ...
              at <strong>business@craftindika.com</strong>.
            </p>
            ...
            <p className="text-base font-medium mb-4">
              ...
              emailing us at <strong>business@craftindika.com</strong>.
            </p>
            ...
            <p className="text-base font-medium mb-4">
              20. <strong>Children’s Privacy</strong>
            </p>
