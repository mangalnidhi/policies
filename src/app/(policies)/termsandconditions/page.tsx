export default function TermsAndConditions() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-between p-8 sm:p-16 lg:p-24">
      <div className="py-8 mt-[-140px]">
        <div className="text-center w-screen">
          <div className="gradient-conic text-white py-14">
            <h3 className="text-3xl font-medium">Terms and Conditions</h3>
          </div>
        </div>
        <div className="max-w-3/4 w-full sm:w-[90%] mx-auto mt-8 text-justify">
          <div className="text-justify">
            ...
            <p className="text-base font-medium mb-4">
              Welcome to <strong>CRAFTINDIKA RETAIL PRIVATE LIMITED</strong>{" "}
              (“Company”, “we”, “our”, “us”)!
            </p>
            ...
            <p className="text-base font-medium mb-4">
              ...
              <strong>https://craftindika.com</strong> (together or individually
              “Service”) operated by{" "}
              <strong>CRAFTINDIKA RETAIL PRIVATE LIMITED</strong>.
            </p>
            ...
            <p className="text-base font-medium mb-4">
              ...
              <strong>business@craftindika.com</strong> so we can try to find a
            ...
            <p className="text-base font-medium mb-4">
              ...
              emailing at business@craftindika.com.
            </p>
            ...
            <p className="text-base font-medium mb-4">
              ...
              Billing cycles will be set depending on the type of subscription
            ...
            <p className="text-base font-medium mb-4">
              ...
              cancel it or CRAFTINDIKA RETAIL PRIVATE LIMITED cancels it. You
              may cancel your Subscription renewal either through your online
              account management page or by contacting business@craftindika.com
              customer support team.
            </p>

            <p className="text-base font-medium mb-4">
              A valid payment method is required to process the payment for your
              subscription. You shall provide CRAFTINDIKA RETAIL PRIVATE LIMITED
              ...
              CRAFTINDIKA RETAIL PRIVATE LIMITED to charge all Subscription fees
              incurred through your account to any such payment instruments.
            </p>

            <p className="text-base font-medium mb-4">
              Should automatic billing fail to occur for any reason, CRAFTINDIKA
              RETAIL PRIVATE LIMITED reserves the right to terminate your access
            ...
            <p className="text-base font-medium mb-4">
              CRAFTINDIKA RETAIL PRIVATE LIMITED may, at its sole discretion,
              offer a Subscription with a free trial for a limited period of
              time (&#8220;Free Trial&#8221;).
            </p>
            ...
            <p className="text-base font-medium mb-4">
              ...
              Trial, you will not be charged by CRAFTINDIKA RETAIL PRIVATE
              LIMITED until Free Trial has expired. On the last day of Free
            ...
            <p className="text-base font-medium mb-4">
              At any time and without notice, CRAFTINDIKA RETAIL PRIVATE LIMITED
            ...
            <p className="text-base font-medium mb-4">
              CRAFTINDIKA RETAIL PRIVATE LIMITED, in its sole discretion and at
            ...
            <p className="text-base font-medium mb-4">
              CRAFTINDIKA RETAIL PRIVATE LIMITED will provide you with a
            ...
            <p className="text-base font-medium mb-4">
              We issue refunds for Contracts within <strong>2 days</strong> of
              the original purchase of the Contract. The Refund will be issued
              only in case of Damaged product or product which are shipped
              wrongly. As we deal with Handicraft and Art items, every product
              is distinct and vary from the original shape, design, weight,
              colour etc from the image shown in the website or from the
              description written as part of product description. At no
              circumstances request for refund shall be initiated in case the
              product does not vary significantly from the original products
            ...
            <p className="text-base font-medium mb-4">
              ...
              CRAFTINDIKA RETAIL PRIVATE LIMITED or used with permission. You
            ...
            <p className="text-base font-medium mb-4">
              ...
              exclusive property of CRAFTINDIKA RETAIL PRIVATE LIMITED and its
              ...
              consent of CRAFTINDIKA RETAIL PRIVATE LIMITED.
            </p>
            ...
            <p className="text-base font-medium mb-4">
              ...
              via email to business@craftindika.com, with the subject line:
            ...
            <p className="text-base font-medium mb-4">
              You may provide us either directly at business@craftindika.com or
            ...
            <p className="text-base font-medium mb-4">
              ...
              that are not owned or controlled by CRAFTINDIKA RETAIL PRIVATE
              LIMITED.
            </p>

            <p className="text-base font-medium mb-4">
              CRAFTINDIKA RETAIL PRIVATE LIMITED has no control over, and
            ...
            <p className="text-base font-medium mb-4">
              ...
              support by email:{" "}
              <a href="mailto:business@craftindika.com">
                <strong>business@craftindika.com</strong>
              </a>
              .
            </p>
          </div>
